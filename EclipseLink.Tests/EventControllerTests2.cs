...
namespace EclipseLink.Tests
{
    public class EventControllerTests
    {
        ...
        {
            // Arrange
            var eventObj = new EclipseLink.Event.Event(1) { Name = "Test Event" }; // Fully qualify the Event class to avoid namespace conflict
        ...
        {
            // Arrange
            _mockEventStore.Setup(store => store.Get(1)).Returns((EclipseLink.Event.Event)null); // Fully qualify the Event class
